...
const Modal:React.FC<props> = ({children, value, variant})=>{
    ...
    return (
       <>
        ...
        <div className={`w-[500px] min-h-[200px] h-auto max-h-[450px] fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] overflow-y-auto bg-white rounded-md shodow-md z-30 ${isOpen ? 'flex' : 'hidden'}`}>
